...
function doIteracao(){
	...
	if(first_entrada == "$" && last_pilha == "$"){
		...
		// Cria uma nova iteração / Pega a sentença que será usada / Divide o Array no meio
...
function drawFita(){
	$("#resultado").html('');
	$("#resultado").append('<table class="table table-striped table-dark" id="table-fita"><tr id="fita"></tr></table>');
